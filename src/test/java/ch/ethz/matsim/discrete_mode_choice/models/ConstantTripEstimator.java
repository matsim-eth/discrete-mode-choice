...
import ch.ethz.matsim.discrete_mode_choice.model.nested.DefaultNestedTripCandidate;
import ch.ethz.matsim.discrete_mode_choice.model.nested.Nest;
...
public class ConstantTripEstimator implements TripEstimator {
	...
	public TripCandidate estimateTrip(Person person, String mode, DiscreteModeChoiceTrip trip,
		...
		return new DefaultNestedTripCandidate(utilities.get(mode), mode, nests.get(mode));
	}
}
