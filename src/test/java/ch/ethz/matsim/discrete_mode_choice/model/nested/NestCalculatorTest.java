...
public class NestCalculatorTest {
	...
	public void testNoNesting() throws NoFeasibleChoiceException {
		...
		NestedUtilityCandidate carCandidate = new DefaultNestedTripCandidate(-1.0, "car", structure.getRoot());
		NestedUtilityCandidate busCandidate = new DefaultNestedTripCandidate(-2.0, "bus", structure.getRoot());
	...
	public void testNoNestingRedBlue() throws NoFeasibleChoiceException {
		...
		NestedUtilityCandidate carCandidate = new DefaultNestedTripCandidate(-1.0, "car", structure.getRoot());
		NestedUtilityCandidate redbusCandidate = new DefaultNestedTripCandidate(-1.0, "redbus", structure.getRoot());
		NestedUtilityCandidate bluebusCandidate = new DefaultNestedTripCandidate(-1.0, "bluebus", structure.getRoot());
	...
	public void testNestedBalancedRedBlue() throws NoFeasibleChoiceException {
		...
		NestedUtilityCandidate carCandidate = new DefaultNestedTripCandidate(-1.0, "car", structure.getRoot());
		NestedUtilityCandidate redbusCandidate = new DefaultNestedTripCandidate(-1.0, "redbus", busNest);
		NestedUtilityCandidate bluebusCandidate = new DefaultNestedTripCandidate(-1.0, "bluebus", busNest);
		...
		assertEquals(Math.log(2.0 * Math.exp(-1.0)), calculator.calculateExpectedUtility(busNest));
		assertEquals(0.5, calculator.calculateConditionalProbability(redbusCandidate));
		assertEquals(0.5, calculator.calculateConditionalProbability(bluebusCandidate));
		...
		assertEquals(-0.9306852819440055, calculator.calculateExpectedUtility(busNest));
		assertEquals(0.5, calculator.calculateConditionalProbability(redbusCandidate));
		assertEquals(0.5, calculator.calculateConditionalProbability(bluebusCandidate));
		...
		assertEquals(-0.9930685281944005, calculator.calculateExpectedUtility(busNest));
		assertEquals(0.5, calculator.calculateConditionalProbability(redbusCandidate));
		assertEquals(0.5, calculator.calculateConditionalProbability(bluebusCandidate));
	...
	public void testNestedUnbalancedRedBlue() throws NoFeasibleChoiceException {
		...
		NestedUtilityCandidate carCandidate = new DefaultNestedTripCandidate(-1.0, "car", structure.getRoot());
		NestedUtilityCandidate redbusCandidate = new DefaultNestedTripCandidate(-0.5, "redbus", busNest);
		NestedUtilityCandidate bluebusCandidate = new DefaultNestedTripCandidate(-1.0, "bluebus", busNest);
